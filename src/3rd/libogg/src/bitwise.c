...
int oggpackB_writecheck(oggpack_buffer *b) { return oggpack_writecheck(b); }
...
static void oggpack_writecopy_helper(oggpack_buffer *b, void *source, long bits,
                                     void (*w)(oggpack_buffer *, unsigned long,
                                               int),
                                     int msb) {
...
void oggpackB_adv(oggpack_buffer *b, int bits) { oggpack_adv(b, bits); }
...
void oggpackB_adv1(oggpack_buffer *b) { oggpack_adv1(b); }
...
long oggpackB_bits(oggpack_buffer *b) { return oggpack_bits(b); }
...
int main(void) {
  ...
  static unsigned long large[] = {
      2136531625L, 2137861823, 56732452, 131, 3212421,    12325343, 34547562,
      12313212,    1233432,    534,      5,   2146435231, 14436467, 7869299,
      76326614,    167548585,  85525151, 0,   12321,      1,        2146528352};

  int onesize = 33;
  static int one[33] = {146, 25, 44,  151, 195, 15,  153, 176, 233, 131, 196,
                        65,  85, 172, 47,  40,  34,  242, 223, 136, 35,  222,
                        211, 86, 171, 50,  225, 135, 214, 75,  172, 223, 4};
  static int oneB[33] = {150, 101, 131, 33,  203, 15,  204, 216, 105, 193, 156,
                         65,  84,  85,  222, 8,   139, 145, 227, 126, 34,  55,
                         244, 171, 85,  100, 39,  195, 173, 18,  245, 251, 128};
  ...
  int threesize = 54;
  static int three[54] = {169, 2,   232, 252, 91,  132, 156, 36,  89,  13,  123,
                          176, 144, 32,  254, 142, 224, 85,  59,  121, 144, 79,
                          124, 23,  67,  90,  90,  216, 79,  23,  83,  58,  135,
                          196, 61,  55,  129, 183, 54,  101, 100, 170, 37,  127,
                          126, 10,  100, 52,  4,   14,  18,  86,  77,  1};
  ...
  /* this is partly glassbox; we're mostly concerned about the allocation
   * boundaries */
