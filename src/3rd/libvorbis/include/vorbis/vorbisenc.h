 ...
 * unset. \param min_bitrate      Desired minimum bitrate. -1 indicates unset.
 *
 * \return Zero for success, and negative values for failure.
 *
 * \retval 0          Success.
 * \retval OV_EFAULT  Internal logic fault; indicates a bug or heap/stack
 * corruption. \retval OV_EINVAL  Invalid setup request, eg, out of range
 * argument. \retval OV_EIMPL   Unimplemented mode; unable to comply with
 * bitrate request.
 */
extern int vorbis_encode_init(vorbis_info *vi, long channels, long rate,
 ...
 * bitrate request.
 */
extern int vorbis_encode_setup_managed(vorbis_info *vi, long channels,
                                       long rate,
 ...
 * corruption. \retval  OV_EINVAL  Invalid setup request, eg, out of range
 * argument. \retval  OV_EIMPL   Unimplemented mode; unable to comply with
 * quality level request.
 */
extern int vorbis_encode_setup_vbr(vorbis_info *vi, long channels, long rate,
 ...
 * quality level request.
 */
extern int vorbis_encode_init_vbr(vorbis_info *vi, long channels, long rate,
