    ...
    if (n == 1 && c->dec_maxlength == 1) {
      ...
      for (i = 0; i < n; i++) {
        if (c->dec_codelengths[i] <= c->dec_firsttablen) {
          ...
          for (j = 0; j < (1 << (c->dec_firsttablen - c->dec_codelengths[i]));
               j++)
...
/* no mapping */
static_codebook test1 = {4, 16, NULL, 0, 0, 0, 0, 0, NULL, 0};
static float *test1_result = NULL;

/* linear, full mapping, nonsequential */
static_codebook test2 = {
    4, 3, NULL, 2, -533200896, 1611661312, 4, 0, full_quantlist1, 0};
static float test2_result[] = {-3, -2, -1, 0, 1, 2, 3, 4, 5, 0, 3, -2};

/* linear, full mapping, sequential */
static_codebook test3 = {
    4, 3, NULL, 2, -533200896, 1611661312, 4, 1, full_quantlist1, 0};
static float test3_result[] = {-3, -5, -6, -6, 1, 3, 6, 10, 5, 5, 8, 6};

/* linear, algorithmic mapping, nonsequential */
static_codebook test4 = {
    3, 27, NULL, 1, -533200896, 1611661312, 4, 0, partial_quantlist1, 0};
...
static_codebook test5 = {
    3, 27, NULL, 1, -533200896, 1611661312, 4, 1, partial_quantlist1, 0};
