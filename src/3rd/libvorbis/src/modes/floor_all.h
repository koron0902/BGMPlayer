...
static const static_codebook *const _floor_Xx0_books[] = {0};
...
static const static_codebook *const *const _floor_books[11] = {
    ...
    _floor_512x17_books,   _floor_Xx0_books,
};
...
static const vorbis_info_floor1 _floor[11] = {
    ...
    {6,
     ...
     {{3}, {4, 5}, {-1, 6, 7, 8}, {-1, 9, 10, 11}},
     2,
     {0, 512, 46, 186, 16, 33, 65, 93, 130, 278, 7, 23, 39, 55, 79, 110, 156,
      232, 360},
    ...
    {0, {0}, {0}, {0}, {-1}, {{-1}}, 2, {0, 12}, 60, 30, 500, 1., 18., 10},
